...
#if defined(_OPENMP) && defined(_OPENMP_MAJOR) && (_OPENMP_MAJOR >= 3)
...
#ifdef _OPENMP
   fprintf(stderr,"OpenMP specification c. %d %d.%d\n", openmp_version(), openmp_version_major(), openmp_version_minor());

   if (openmp_has_atomics())
...
#if defined(_OPENMP) && (_OPENMP_MAJOR >= 3)
